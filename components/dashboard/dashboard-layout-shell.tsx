			...
			{auth.authenticated ? (
				<main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
					...
					{/*
						...
						wherever the operator navigates — and inside its own
						QueryProvider, because this shell renders *above* the per-page
						one. Without it the dock's useQuery throws "No QueryClient set"
						during render and takes every authenticated page down with it.
						getQueryClient() is a browser singleton, so this shares the same
						cache rather than creating a second.
					*/}
					<QueryProvider>
						<ScanProgressDock />
					</QueryProvider>
