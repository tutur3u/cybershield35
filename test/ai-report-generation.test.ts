...
const validReport = {
	...
	recommendations: ["Ưu tiên kiểm chứng các điểm còn khác biệt trước khi sử dụng bên ngoài."],
	limitations: ["Báo cáo chỉ dựa trên bằng chứng có trong lượt quét hiện tại."],
	reviewNotes: ["Con người cần duyệt lại số liệu và tên riêng trước khi phát hành."],
};
