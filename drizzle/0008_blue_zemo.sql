...
VALUES
	(
		'taynguyennanggiodaingan',
		'https://www.facebook.com/taynguyennanggiodaingan',
		'facebook_page',
		'apify_facebook_posts',
		true,
		'{"label":"taynguyennanggiodaingan"}'::jsonb
	),
	(
		'hongbien47fanpage',
		'https://www.facebook.com/hongbien47fanpage',
		'facebook_page',
		'apify_facebook_posts',
		true,
		'{"label":"hongbien47fanpage"}'::jsonb
	)
